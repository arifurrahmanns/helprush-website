...
function page() {
    return (
        <div className="container py-10 lg:py-20">
            ...
            <p>HelpRush, operated by Horfay Taqnia Private Limited, is committed to maintaining a fair and transparent cancellation and refund policy. Our goal is to balance the interests of customers and service providers while ensuring a smooth and reliable experience for all users.</p>
