...
import { cn, foratPhone, phoneCode } from '@/lib/utils'
...
function Otpverification({ callBack }) {
        ...
        <div>
            {step == 1 ? <form action={formAction} className="flex lg:col-span-2 formElement flex-col gap-5">
                <div className="flex flex-col gap-3">
                    ...
                    <div>
                        <div className="flex items-center relative">
                            <div className='absolute  h-14   text-neutral-600 border-r pr-4 py-2 text-base  md:text-lg pl-4  flex items-center '>+{phoneCode()}</div>
                ...
                <form action={validationFormAction} className="flex lg:col-span-2 formElement flex-col gap-5 ">
                    <div className="flex flex-col gap-3">
                        <label htmlFor="phone" className="text-black  font-semibold !leading-snug text-xl lg:text-4xl">Enter the 6-digit code sent via SMS at <br /> {foratPhone(`+${phoneCode()}${phone}`)}</label>
                        ...
                        <div>
                            <InputOTP name="otp" maxLength={6}>
                                ...
                                <InputOTPGroup className="w-1/2">
                                    ...
                                    <InputOTPSlot className="bg-white  h-14 text-base md:text-lg" index={4} />
                                    <InputOTPSlot className="bg-white  h-14 text-base md:text-lg" index={5} />
